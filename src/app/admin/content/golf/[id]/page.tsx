    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        <div className="flex items-center gap-4 mb-8">
          <Link href="/admin/content/golf" className="text-sm text-slate-500 hover:text-slate-700">
            &larr; 골프장 목록
          </Link>
          <h1 className="text-2xl font-bold text-slate-900">{course.nameKo} 수정</h1>
        </div>
        <div className="bg-white rounded-2xl p-8 shadow border border-slate-100">
          <GolfForm course={course} />
        </div>
      </main>
      <Footer />
    </div>
